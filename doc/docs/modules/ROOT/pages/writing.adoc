...
link:https://org.neo4j.neo4j.com/docs/cypher-manual/current/syntax/values/[Neo4j Type]) the Connector will
...
val originalDf = spark.read.format("org.spark.DataSource")
