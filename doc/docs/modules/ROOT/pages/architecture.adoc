...
In the link:https://org.neo4j.neo4j.com/developer/guide-performance-tuning/[Neo4j Performance Tuning Guide], important
...
You can tune the configuration parameters of the https://org.neo4j.neo4j.com/labs/apoc/4.1/database-introspection/meta/[two APOC procedures]
